...
## Objective
Preserve the accepted I0–I2 pattern foundation while preparing a separately approved I3 activation.
...
Record the accepted I2 evidence and the requirements for planning-only I3 activation.
...
## Next exact action
Create the planning-only I3 activation record defining compiler limits, banned modules, warning policy, tests, and non-goals; do not modify production code.
